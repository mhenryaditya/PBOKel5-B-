...
import dialog.FormDetailProduk;
import form.FormBEL;
...
public class Card extends javax.swing.JPanel{
    ...
    public Card(Model_Card data, MainForm main, String id, int idStaff, MainApplication mainApp) {
        ...
        cardDescription.setSize(new Dimension(200, 150));
        add(cardDescription);
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                if(showMessage(id)){
                    main.showForm(new FormBEL(id, main));
                }
            }
        });
    }
    ...
    public void paint(Graphics grphcs) {
        ...
        GradientPaint g = new GradientPaint(0, getHeight(), new Color(240, 166, 18, 200), 0, getHeight() - 50, new Color(0, 0, 0, 0));
        g2.setPaint(g);
