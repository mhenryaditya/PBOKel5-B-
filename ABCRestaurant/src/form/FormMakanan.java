...
public class FormMakanan extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        panel.add(new boxinformation.Card(new Model_Card(new ImageIcon(getClass().getResource("/fotoMenu/nasi-goreng-from-indonesia-in-illustration-vector-removebg-preview.png")), "Nasi Goreng Spesial", "Harga : \n       Rp." + String.valueOf(getPrice("Nasi Goreng Special")) + "\nStok : \n       " + String.valueOf(getStok("Nasi Goreng Special"))), main, getId("Nasi Goreng Special"), idStaff, mainApp));
        panel.add(new boxinformation.Card(new Model_Card(new ImageIcon(getClass().getResource("/fotoMenu/65f26bce6c7502b469ff8ffe3a02e35a-removebg-preview.png")), "Sate Ayam Madura", "Harga : \n       Rp." + String.valueOf(getPrice("Sate Ayam Madura")) + "\nStok : \n       " + String.valueOf(getStok("Sate Ayam Madura"))), main, getId("Sate Ayam Madura"), idStaff, mainApp));
        panel.add(new boxinformation.Card(new Model_Card(new ImageIcon(getClass().getResource("/fotoMenu/rendang.png")), "Rendang Daging", "Harga : \n       Rp." + String.valueOf(getPrice("Rendang Daging")) + "\nStok : \n       " + String.valueOf(getStok("Rendang Daging"))), main, getId("Rendang Daging"), idStaff, mainApp));
        panel.add(new boxinformation.Card(new Model_Card(new ImageIcon(getClass().getResource("/fotoMenu/gado gado.png")), "Gado-Gado", "Harga : \n       Rp." + String.valueOf(getPrice("Gado-Gado")) + "\nStok : \n       " + String.valueOf(getStok("Gado-Gado"))), main, getId("Gado-Gado"), idStaff, mainApp));
        panel.add(new boxinformation.Card(new Model_Card(new ImageIcon(getClass().getResource("/fotoMenu/soto ayam.png")), "Soto Ayam", "Harga : \n       Rp." + String.valueOf(getPrice("Soto Ayam")) + "\nStok : \n       " + String.valueOf(getStok("Soto Ayam"))), main, getId("Soto Ayam"), idStaff, mainApp));
        panel.add(new boxinformation.Card(new Model_Card(new ImageIcon(getClass().getResource("/fotoMenu/pecel lele.png")), "Pecel Lele", "Harga : \n       Rp." + String.valueOf(getPrice("Pecel Lele")) + "\nStok : \n       " + String.valueOf(getStok("Pecel Lele"))), main, getId("Pecel Lele"), idStaff, mainApp));
        panel.add(new boxinformation.Card(new Model_Card(new ImageIcon(getClass().getResource("/fotoMenu/nasi Padang.png")), "Nasi Padang", "Harga : \n       Rp." + String.valueOf(getPrice("Nasi Padang")) + "\nStok : \n       " + String.valueOf(getStok("Nasi Padang"))), main, getId("Nasi Padang"), idStaff, mainApp));
        panel.add(new boxinformation.Card(new Model_Card(new ImageIcon(getClass().getResource("/fotoMenu/bakso malang.png")), "Bakso Malang", "Harga : \n       Rp." + String.valueOf(getPrice("Bakso Malang")) + "\nStok : \n       " + String.valueOf(getStok("Bakso Malang"))), main, getId("Bakso Malang"), idStaff, mainApp));
        panel.add(new boxinformation.Card(new Model_Card(new ImageIcon(getClass().getResource("/fotoMenu/ayam goreng Kalasan.png")), "Ayam Goreng Kalasan", "Harga : \n       Rp." + String.valueOf(getPrice("Ayam Goreng Kalasan")) + "\nStok : \n       " + String.valueOf(getStok("Ayam Goreng Kalasan"))), main, getId("Ayam Goreng Kalasan"), idStaff, mainApp));
        panel.add(new boxinformation.Card(new Model_Card(new ImageIcon(getClass().getResource("/fotoMenu/lontong sayur Betawi.png")), "Lontong Sayur Betawi", "Harga : \n       Rp." + String.valueOf(getPrice("Lontong Sayur Betawi")) + "\nStok : \n       " + String.valueOf(getStok("Lontong Sayur Betawi"))), main, getId("Lontong Sayur Betawi"), idStaff, mainApp));
        panel.revalidate();
        panel.repaint();
    }
