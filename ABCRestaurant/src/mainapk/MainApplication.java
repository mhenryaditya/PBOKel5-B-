...
import mainStruktur.Header;
import mainStruktur.Menu;
import dialog.Message;
import event.EventMenuSelected;
import event.EventShowPopupMenu;
import form.Dashboard;
import form.FormMakanan;
import form.FormMinuman;
import form.KasManager;
...
public class MainApplication extends javax.swing.JFrame {
    ...
    public MainApplication(int id) {
        ...
        init();
        setTitle("ABC Restaurant - " + getNameDb());
    }
...
//                System.out.println("Menu Index : " + menuIndex + " SubMenu Index " + subMenuIndex);
                switch (menuIndex) {
                    ...
                    case 2:
                        // To Keuangan
                        main.showForm(new KasManager(main, getNameDb()));
                        break;
                    default:
