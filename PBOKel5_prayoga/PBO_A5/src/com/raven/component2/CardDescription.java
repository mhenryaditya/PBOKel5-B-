...
public class CardDescription extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txt = new com.raven.swing2.TextArea();
        ...
        txt.setColumns(20);
        txt.setRows(5);
        txt.setMinimumSize(new java.awt.Dimension(107, 22));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lbTitle, javax.swing.GroupLayout.DEFAULT_SIZE, 188, Short.MAX_VALUE)
                .addContainerGap())
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(txt, javax.swing.GroupLayout.DEFAULT_SIZE, 22, Short.MAX_VALUE))
        );
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        f.moveTo(0, 30);
        f.curveTo(50, 0, 100, 40, 200, 0);
        f.lineTo(200, getHeight());
    ...
    private com.raven.swing2.TextArea txt;
