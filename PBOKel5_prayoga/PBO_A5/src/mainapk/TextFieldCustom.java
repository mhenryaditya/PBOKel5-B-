...
public class TextFieldCustom extends JTextField {
    ...
    public TextFieldCustom() {
        ...
        setSelectionColor(new Color(3, 204, 255));
    ...
    private void createHintText(Graphics2D g2){
        ...
        double height = (getHeight() - in.top - in.bottom), textY = ((height - r2.getHeight()) / 2), size;
        if (animatehintText) {
            size = (show == true) ? (18 * (1 - location)) : (18 * location);
        } else {
            size = 18;
        }
