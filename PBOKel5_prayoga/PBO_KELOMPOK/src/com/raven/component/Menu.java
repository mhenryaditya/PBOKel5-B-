...
public class Menu extends javax.swing.JPanel {
    ...
    public void initMenuItem() {
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/com/raven/icon/1.png")), "Menu", "Makanan", "Minuman"));
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/com/raven/icon/2.png")), "Keuangan", "Isi Saldo", "Tarik Saldo"));
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/com/raven/icon/13.png")), "Daftar Pesanan"));
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        GradientPaint gra = new GradientPaint(0, 0, new Color(240, 166, 18), getWidth(), 0, new Color(236, 89, 11));
        g2.setPaint(gra);
